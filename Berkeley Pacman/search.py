...
def depthFirstSearch(problem):
    ...
    explored = []
    fringe = Stack()  # define the fringe as a Stack. You can check util.py
...
def breadthFirstSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    explored = []
    fringe = Queue()  # define the fringe as a Queue. You can check util.py
    # adding the first node into the fringe
    fringe.push([(problem.getStartState(), "Stop", 0)])
    # please note that each node is represented using the path from the starting node to the it
    while not fringe.isEmpty():
...
def uniformCostSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    explored = []
    # cost = lambda parameter_list: expression
    # define the fringe as a Stack. You can check util.py
